...
- Standard deviation (evacuated): 5.7822
- Standard deviation (deaths): 2.2010
- Standard deviation (trapped): 5.2926

### Required Sample Size Calculation

Based on pilot variability and desired precision:

- Required for evacuated (E=5): 6 simulations
- Required for deaths (E=5): 1 simulations
- Required for trapped (E=5): 5 simulations
- **Maximum required: 6 simulations**

### Convergence Results

- Total simulations executed: 10
- Final mean (evacuated): 183.90 ± 5.78
- Final mean (deaths): 122.80 ± 2.20
- Final mean (trapped): 158.30 ± 5.29
